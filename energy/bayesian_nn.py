...
class EEBayesianSingleLayer(object):
    def __init__(self, input_dim=8, output_dim=1, batch_size=1):
        self.input_dim = input_dim
        self.output_dim = output_dim
        self.batch_size = batch_size
        self.num_layer = 2

        self.w1_shape = [input_dim, 10]
        self.w2_shape = [10, output_dim]
        self.b1_shape = [10]
        ...
        self.all_layer_inference.initialize(n_samples=8, n_iter=1000)
...
class EESingleLayer(object):
    def __init__(self, input_dim=8, output_dim=1, batch_size=1):
        self.model = Sequential()
        self.model.add(Dense(10, input_dim=input_dim, kernel_initializer='normal', activation='relu'))
